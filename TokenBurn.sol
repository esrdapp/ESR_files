...
// and the ESR devs will not be able to retrieve any HPB or tokens sent
// to this contract.
...
// accidentally sending their own ESR tokens to 0x0. IF they did this
// accidentally it would throw an error and the tokens would not be sent there.
